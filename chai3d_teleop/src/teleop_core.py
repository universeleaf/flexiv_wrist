...
class RelativePoseMapper:
    ...
    def __init__(self, config: MappingConfig, axis_map: np.ndarray):
        self.config = config
    ...
    def target(self, sample: HapticSample) -> np.ndarray:
        ...
        delta_device = sample.position - self._device_anchor.position
        ...
        if self.config.enable_rotation:
            ...
            mapped_relative = self.axis_map @ relative_device @ self.axis_map.T
